...
<TouchableOpacity style={{width:'45%',height:'100%',backgroundColor:props.backgroundColor ? props.backgroundColor :COLORS.Primary_Blue,justifyContent:'center',borderRadius:10}}
