import {
  ...
  const eventClicked = (event) => {
    ...
    // props.navigation.navigate('ServiceDetails',{data:event})
        ...
        <EventCalendar
          ...
          renderEvent={(data)=>{
            ...
            return(
                ...
                props.navigation.navigate('ServiceDetails',{data:data})
                    }}>
                ...
                {/*   <View style={{flexDirection:"row",justifyContent:"space-between",marginTop:15}}>
                 <View style={{ flexDirection: 'row', alignItems: 'center', width: '45%',marginLeft:15 }}>
                          <Image style={{ width: 20, height: 20, resizeMode: 'stretch', }} source={require('../../assets/images/Icons/clock.png')} />
                         <View style={{marginLeft:5}}>
                         <Text style={{ color: '#000', fontWeight: '400', fontSize: 10, left: 3,  }}>Check in</Text>
                         <Text style={{ color: 'gray', fontWeight: '400', fontSize: 10, left: 3,top:1  }}>{data.start_time} {data.finish_time}{data.start_time==''? 'Pending..':''}</Text>
                         </View>
                        </View>
                         ...
                         <View style={{ flexDirection: 'row', alignItems: 'center', width: '45%',marginLeft:15 }}>
                          <Image style={{ width: 20, height: 20, resizeMode: 'stretch', }} source={require('../../assets/images/Icons/clock.png')} />
                         <View style={{marginLeft:5}}>
                         <Text style={{ color: '#000', fontWeight: '400', fontSize: 10, left: 3,  }}>Check Out</Text>
                         <Text style={{ color: 'gray', fontWeight: '400', fontSize: 10, left: 3,top:1 }}>11:00Am 02:00PM</Text>
                         </View>
                        </View> 
