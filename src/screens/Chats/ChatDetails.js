...
<View style={{position:'absolute',bottom:'5',width:'80%',height:50,backgroundColor:'#fff',borderRadius:30,justifyContent:'center',paddingHorizontal:10,marginLeft:12,top:isKeyboardOpen? H * 0.46 :  H * 0.75,borderColor:'#000',borderWidth:0.5}}>
      <TextInput
