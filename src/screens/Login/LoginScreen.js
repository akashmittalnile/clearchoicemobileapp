...
const LoginScreen = ({navigation}) => {
  ...
  return (
    <ImageBackground source={images.loginbg} style={StyleSheet.absoluteFill}>
      ...
      <View style={[styles.container,{ top: isKeyboardOpen ? 'auto' : 'auto'}]}>
     ...
     <View style={{width:'100%',height:dimensions.SCREEN_HEIGHT*30/100,backgroundColor:'#fff',position:'absolute',bottom:0,alignSelf:'center',borderTopLeftRadius:30,borderTopRightRadius:30,paddingTop:20}}>
