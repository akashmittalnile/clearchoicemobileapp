...
const TimeCard = (props) => {
  ...
  const updateStatus = async () => {
    ...
    formdata.append("service_id", clickeditem.serviceData); //status_id
    formdata.append("date", clickedDate[0].label);
    formdata.append("time", seletedtime);
