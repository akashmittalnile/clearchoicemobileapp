...
const ServiceDetails = (props) => {
  ...
  const updateStatus = async (code) => {
    ...
    if (true) {
      ...
      formdata.append("service_id", DATA.service_id); //status_id
  ...
  const submitTime = async () => {
    ...
    data.append('end_time', date2.toString().substring(16, 21));
    if(machinetype!=null){
          ...
          <View style={{
            ...
            <View style={{ padding: 10, }}>
              ...
              <ImageBackground style={{ width: 125, height: 15, resizeMode: 'stretch', justifyContent: 'center', marginTop: 10 }} source={require('../../assets/images/Icons/stripIcon.png')}>
                <Text style={{ color: '#fff', fontWeight: '500', fontSize: 10, alignSelf: 'center' }}>Satus: {DATA?.status}</Text>
              </ImageBackground>
...
{report ?
        <View style={{ width: '100%', height: dimensions.SCREEN_HEIGHT, position: 'absolute', backgroundColor: 'rgba(0,0,0,0.4)', flex: 1 }}>
          <View style={{ width: '100%', height: dimensions.SCREEN_HEIGHT * 40 / 100, backgroundColor: '#fff', position: 'absolute', bottom: 0, alignSelf: 'center', borderTopLeftRadius: 30, borderTopRightRadius: 30, paddingTop: 20 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text></Text>
