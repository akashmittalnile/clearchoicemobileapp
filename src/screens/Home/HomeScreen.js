...
<Text style={{color:'#fff',fontSize:13,textAlign:'center',fontWeight:'700'}}>Clear</Text>
            ...
            <ScrollView>
                          ...
                          <FlatList
                              ...
                              renderItem={({ item, index }) => {
                                  return (
                                   ...
                                   shadowOpacity: 0.2,
                                   elevation: 3,
                                   marginTop:20,}} onPress={()=>{props.navigation.navigate('ServiceDetails',{data:item})}}>
                    <View style={{padding:10,}}>
                      ...
                      <Text style={{color:'#fff',fontWeight:'500',fontSize:10,alignSelf:'center'}}>Satus: {item?.status}</Text>
                      </ImageBackground>
                     ...
                     <View style={{flexDirection:'row',alignItems: 'center',marginTop:10,alignSelf:'center'}}>
                      <TouchableOpacity style={{}} onPress={()=>{updateStatus(item,'2')}}>
                      ...
                      <TouchableOpacity style={{alignItems:'center'}} onPress={()=>{updateStatus(item,'3')}}>
                      ...
                      <TouchableOpacity style={{alignItems:'center'}} onPress={()=>{updateStatus(item,'4')}}>
